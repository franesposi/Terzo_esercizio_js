...
*/
// for ( ; ; ) { singolo in collezione, per accedere dot.notation }
...
*/
// switch ( leggo le caratteristice di eye color e in ciascun array vuoto inserisco (push))
...
while ( i < starWarsCharacters.length) {
  var character = parseInt(starWarsCharacters[i].mass);
  crewMass = (crewMass + character);
  i++;
}
...
*/
// switch e verifico il valore di crewMass in quale case finisce
...
*/
// for() posso fare un nuovo array o riassegno il valore corrispondente (if -> gender è qualcosa ) { riassegno quel valore }
